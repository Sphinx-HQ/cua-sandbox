...
def main(client_id: str, client_secret: str, master_password: str):
...
if __name__ == "__main__":
    main(config.BITWARDEN_CLIENT_ID, config.BITWARDEN_CLIENT_SECRET, config.BITWARDEN_MASTER_PASSWORD)
